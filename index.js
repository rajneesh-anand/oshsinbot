...
bot.onTextMessage((message) => {
    ...
    if (message.body === "Dog" || message.body === "DOG" || message.body === "dog") {
        request.post({
    ...
    } else if(message.body === "Video" || message.body === "VIDEO" || message.body === "video"){
        ...
        request.post({
            ...
            json: {
                ...
                "type": "video",
                "to": message.from,
                "videoUrl": "https://static.videezy.com/system/resources/previews/000/053/979/original/Stray_Dog_Sitting_On_The_Grass_3.mp4",
                "muted": true,
                "autoplay": false,
                    }
                ]
            ...
            "messages": [
                {
                    ...
                    "picUrl": "https://ichef.bbci.co.uk/news/976/cpsprodpb/C865/production/_118610315_wvtf1.jpg",
                    "attribution": {
                        "name": "My App",
                        "iconUrl": "https://ichef.bbci.co.uk/news/976/cpsprodpb/C865/production/_118610315_wvtf1.jpg"
                    },
                    "noForward": true,
                    "kikJsData": { "key": "value" }
                }
